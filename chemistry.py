...
def main():
    ...
    formula = input('Enter the formula of the sample: ')
    ...
    #call the make_molecule_dict and store in variable
    known_molecules_dict = molecules_dict()
    ...
    #Print formula_name
    print(f'Compund name: {formula_name}')
    #Print protons
